	...
	<tbody>
		<s:iterator value="DATALIST" status="st">
			<tr>
				...
				<td><s:property value="zhouci.mastername" /></td>
				<td><s:property value="jieshu.mastername" /></td>
				<td><s:property value="weizhi.mastername" /></td>
				<td><s:property value="allStuedentCount" /></td>
			</tr>
		</s:iterator>
	</tbody> 
</table>
<div class="dataTables_info" id="dyntable2_info"
	...
	<span class="txt-smaller txt-light"> 当前共有<span class="number"
		style="color: red;"><s:property value="resultCount" /> </span>条课程信息
	</span>
</div>
