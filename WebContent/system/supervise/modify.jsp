...
<form action="../system/supervise/modifyProcess.action" method="post"
	style="margin-left: 20px; margin-right: 20px;" class="stdform stdform2"
	id="editForm">
	<p>
		<label>督教编号</label> <span class="field"> <s:property
				value="supervise.num" />
		</span>
	</p>
	<p>
	...
	<s:hidden name="supervise.id"></s:hidden>
	<s:hidden name="supervise.password"></s:hidden>
	<s:hidden name="supervise.num"></s:hidden>
</form>
