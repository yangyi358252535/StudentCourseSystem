...
<script type="text/javascript"
	src="../system/supervise/js/supervise_main.js" charset="UTF-8"></script>
<div class="contenttitle2" style="margin-left: 20px;">
	<h3 id="userTitle">督教信息列表</h3>
</div>
<div id="supervisebar"
	...
	<div class="tableoptions">
		&nbsp;&nbsp;&nbsp;&nbsp;查询:&nbsp; <select id="condition1" tabindex="1"
			style="width: 130px;">
			<option value="0">全部督教</option>
			<option value="1">按督教编号查询</option>
			<option value="2">按督教姓名查询</option>
