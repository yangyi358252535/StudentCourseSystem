...
$("<td><input class=\"pagination-num\" type=\"text\" value=\"1\" size=\"2\" id=\"pa\" ></td>").appendTo(tr);
...
},beforePageText:"第",afterPageText:"页    共{pages}页  ",displayMsg:"共  {total} 条记录"};
})(jQuery);
(function($){
function _7d(_7e){
var _7f=$(_7e);
...
$.fn.prop?_45e.attr("checked",true):_45e.attr("checked",true);
...
$.fn.prop?_462.attr("checked",false):_462.attr("checked",false);
if(opts.idField){
...
$.fn.prop?ck.attr("checked",true):ck.attr("checked",true);
if(opts.idField){
...
$.fn.prop?ck.attr("checked",false):ck.attr("checked",false);
...
$.fn.prop?$(_4da).attr("checked",_4dc):$(_4da).attr("checked",_4dc);
